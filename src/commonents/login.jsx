...
const Login = () => {
  ...
  return (
    <div className="bg-gray-800 h-screen flex items-center justify-center sm:w-screen sm:justify-start ">
      ...
      >
        <p className="text-white text-3xl ml-60 pb-24 sm:ml-40">Login</p>
        <div className=" flex flex-col items-start pl-72 sm:w-24 sm:pl-0">
          ...
          <div className="border-2 h-12 rounded-md flex items-center sm:ml-6">
            <FaEnvelope className="text-blue-500 text-4xl h-full bg-gray-700 pl-2" />
            <input
              className="w-96 h-full bg-gray-700 p-4 text-white sm:w-72 "
        ...
        <div className=" flex flex-col items-start  pl-72 mt-16 sm:pl-0">
          ...
          <div className="border-2 h-12  rounded-md flex items-center sm:ml-6">
            <FaUserLock className="text-blue-500 text-4xl h-full bg-gray-700 pl-2" />
            <input
          ...
          <button className="bg-gray-700 hover:bg-gray-700 w-full mt-12 h-12 rounded-md text-blue-500 sm:ml-16 sm:w-60">
            Log in
          </button>
          <div>
            <p className="pl-24 mt-4 text-white underline sm:">
              forgotten your password
            </p>
            <p className="text-white mt-4 sm:pl-14 ">
